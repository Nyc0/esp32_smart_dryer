...
static void sntp_time_sync_init_sntp(void) {
    ...
    // Let the http_server_ know service is  initialized
...
void sntp_time_sync_task_start(void) {
    xTaskCreatePinnedToCore(&sntp_time_sync, "sntp_time_sync", SNTP_TIME_SYNC_TASK_STACK_SIZE, NULL, SNTP_TIME_SYNC_TASK_PRIOROTY, NULL, SNTP_TIME_SYNC_TASK_CORE_ID);
}